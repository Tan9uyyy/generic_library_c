...
The hashtable interface conforms to the general map interface described in Chapter~\ref{chap:maps}. However, the underlying structure is exposed for those interested in the implementation details.

\begin{code}
  \lstinputlisting[style=C,linerange={17-27}]{libellul/include/libellul/structure/hashtable/linear/linear.h}
  \caption{The linear hashtable structure.}
  \label{code:hashtable:struct}
\end{code}
