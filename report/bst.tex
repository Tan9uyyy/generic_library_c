...
The interface provides standard operations:
\begin{itemize}
    \item \texttt{insert}: Insert a key-value pair.
    \item \texttt{search}: Find a value by key.
    \item \texttt{delete}: Remove a key-value pair.
    \item \texttt{min/max}: Find the minimum or maximum key.
\end{itemize}
