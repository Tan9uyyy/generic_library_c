...
/* retourne la valeur en tete de la deque */
deque_datum_t   DEQUE_METHOD(first)(T deque);
/* retourne la valeur en queue de la deque */
deque_datum_t   DEQUE_METHOD(last)(T deque);
/* retourne la valeur a l'index donne de la deque */
deque_datum_t   DEQUE_METHOD(get)(T deque, int index);
/* modifie la valeur a l'index donne de la deque et retourne la deque modifiee */
T               DEQUE_METHOD(set)(deque_datum_t value, T deque, int index);
/* insere une valeur en tete de la deque et retourne la nouvelle deque */
T               DEQUE_METHOD(push_front)(deque_datum_t value, T deque);
/* insere une valeur en queue de la deque et retourne la nouvelle deque */
T               DEQUE_METHOD(push_back)(deque_datum_t value, T deque);
/* retire la valeur en tete de la deque, la stocke dans value et retourne la nouvelle deque */
...
/* effectue nb_rot rotations de la deque et retourne la deque modifiee */
...
/* retire l'element obj de la deque et retourne la nouvelle deque */
T               DEQUE_METHOD(remove)(deque_datum_t value, T deque);
/* supprime la deque proprement en utilisant le destructeur sur chaque element */
void            DEQUE_METHOD(delete)(T deque);
/* affiche la deque en utilisant la fonction printer pour chaque element */
