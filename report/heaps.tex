...
We compared our binary heap-based priority queue against a linked-list based implementation.

\begin{figure}[H]
    \centering
    \subfloat[PQ Push]{\includegraphics[width=0.45\textwidth]{pq_push.png}}
    \hfill
    \subfloat[PQ Pop]{\includegraphics[width=0.45\textwidth]{pq_pop.png}}
    \caption{Priority Queue performance: Linked PQ vs. Heap.}
    \label{fig:pq:bench}
\end{figure}
