...
int                 METHOD(T, datum_t, size)(TYPE(T, datum_t) deque);
...
TYPE(T, datum_t)    METHOD(T, datum_t, pop)(datum_t *value, TYPE(T, datum_t) deque, void (*destructor)(datum_t));
TYPE(T, datum_t)    METHOD(T, datum_t, delete)(TYPE(T, datum_t) list, void (*destructor)(datum_t));
void                METHOD(T, datum_t, print)(TYPE(T, datum_t) deque, void (*printer)(datum_t));
