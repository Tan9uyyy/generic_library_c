...
void treeset_tests(){
    ...
    printf("lower bound = %d, upper bound = %d\n", int_treeset_lower_bound(treeset1), int_treeset_upper_bound(treeset1));
    printf("lower bound = %d, upper bound = %d\n", int_treeset_lower_bound(treeset2), int_treeset_upper_bound(treeset2));
    ...
    int_treeset_t treeset_inter = int_treeset_inter(treeset1, treeset2);

    printf("Treeset1 : "); int_treeset_print(treeset1);
    printf("Treeset2 : "); int_treeset_print(treeset2);
    printf("Treeset_inter : "); int_treeset_print(treeset_inter);
    ...
    printf("Intersect bounds : %d, %d\n", int_treeset_lower_bound(treeset_inter), int_treeset_upper_bound(treeset_inter));
    printf("Expected bounds : %d, %d\n", values1[3], values2[1]);
    ...
    test_assert(int_treeset_lower_bound(treeset_inter) == values1[3] && int_treeset_upper_bound(treeset_inter) == values2[1], "Treesets intersection is correct");
    ...
    treeset_inter = int_treeset_delete(treeset_inter);
    ...
    test_assert(int_treeset_is_empty(treeset_inter), "treeset_inter deleted");
